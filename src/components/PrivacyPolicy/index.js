...
const PrivacyPolicy = () => (
  <div>
      ...
      <div className='ppConsistencies'>
        ...
        <div className='col-2'>
          <div className="col-12 quick-links2 gen-text-center">
            ...
            <div className="col-8 gen-text-left gen-xs-text-center" style={{ fontSize: '12px',
              position: 'relative', left: '20px' }}>Fair information<br /> Practices</div>
        </div>
      </div>
      <div className='col-2'>
    ...
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&bull;</strong> Understand and save user's
      preferences for future visits.</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&bull;</strong> Compile aggregate data about
      ...
      this information on our behalf.</div>
    <div className='innerText'>
      <br /> You can choose to have your computer warn you each time a cookie is being
    ...
    <div className='innerText'>
      ...
      to keep this information confidential. We may also release information when it's
      ...
      <br />
      <br /> However, non-personally identifiable visitor information may be provided
    ...
    <div className='innerText'>
      <br /> Google, as a third-party vendor, uses cookies to serve ads on our site.
      ...
      of the use of the DART cookie by visiting the Google Ad and Content Network privacy
      policy.
      <br />
    </div>
    <div className='innerText'>
    ...
    <div className='innerText'>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Demographics and Interests
      Reporting
    </div>
    <br />
    <div className='innerText'>
    ...
    <div className='innerText'>
      ...
      <br /> Users can set preferences for how Google advertises to you using the Google
    ...
    <div className='innerText'>
      ...
      to require any person or company in the United States (and conceivably the world)
    ...
    <div className='innerText'>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> On our Privacy Policy
      Page
      <br />
    </div>
    <div className='innerText'>
    ...
    <div className='innerText'>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By logging in to your
      account
    </div>
    <div className='innerText'>
      <br />
    ...
    <div className='innerText'>
      <strong>In order to be in line with Fair Information Practices we will take the following responsive action,
        should a data breach occur:</strong>
    </div>
    <div className='innerText'>
    ...
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Within 7 business days</div>
    <div className='innerText'>
      <br /> We also agree to the Individual Redress Principle which requires that
    ...
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Send information, respond
      to inquiries, and/or other requests or questions</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Process orders and to send
      information and updates pertaining to orders.</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Send you additional information
      related to your product and/or service</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Market to our mailing list
    ...
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Not use false or misleading
      subjects or email addresses.</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Identify the message as
      an advertisement in some reasonable way.
    </div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Include the physical address
      of our business or site headquarters.</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Monitor third-party email
      marketing services for compliance, if one is used.</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Honor opt-out/unsubscribe
      requests quickly.</div>
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Allow users to unsubscribe
      by using the link at the bottom of each email.</div>
    <div className='innerText'>
      <strong>
              <br />
    ...
    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Follow the instructions
      at the bottom of each email.</div>
  ...
  <div className='innerText'>https://wallet.p.ua</div>
  <div className='innerText'>Derevyanko Street 1, APT 12</div>
  Kharkiv, Kharkivska Oblast 61103
  <div className='innerText'>Ukraine</div>
  <div className='innerText'>login.was.here+support.wallet.pp.ua@gmail.com</div>
  <div className='innerText'><br />Last Edited on 2017-01-12</div>
</div>
)
