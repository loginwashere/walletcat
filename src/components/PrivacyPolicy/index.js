  ...
  <div>
    ...
    <div id='ppBody'>
      ...
      <div className='ppConsistencies'>
        ...
        <div className='col-2'>
          <div className="col-12 quick-links2 gen-text-center">
            ...
            <div className="col-8 gen-text-left gen-xs-text-center"
                 style={{fontSize:'12px', position:'relative', left:'20px'}}>Fair information<br /> Practices</div>
          </div>
        </div>
        <div className='col-2'>
      ...
      <div className='innerText'>
        ...
        <div className='innerText'>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To send periodic emails regarding your order or other products and services.
        </div>
        <div className='innerText'>
        ...
        <div className='innerText'>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Demographics and Interests Reporting
        </div>
        <br />
        <div className='innerText'>
        ...
        <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Market to our mailing list or continue to send emails to our clients after the original transaction has occurred.</div>
        <div className='innerText'>
          <br />
        ...
        <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Follow the instructions at the bottom of each email.</div> and we will promptly remove you from <strong>ALL</strong> correspondence.
      </div>
      <br />
      <span id='ourCon'></span>
      <br />
