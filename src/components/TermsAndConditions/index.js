...
const TermsAndConditions = () => (
  <div>
    ...
    <p>These Website Standard Terms and Conditions written on this webpage shall manage your use of this website. These
      Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed to accept
    ...
    <p>Other than the content you own, under these Terms, Wallet Cat and/or its licensors own all the intellectual
    ...
    <p>Certain areas of this Website are restricted from being access by you and Wallet Cat may further restrict access
    ...
    <p>In these Website Standard Terms and Conditions, “Your Content” shall mean any audio, video text, images or other
      material you choose to display on this Website. By displaying Your Content, you grant Wallet Cat a non-exclusive,
      worldwide irrevocable, sub licensable license to use, reproduce, adapt, publish, translate and distribute it
      in any and all media.</p>
    <p>Your Content must be your own and must not be invading any third-party’s rights. Wallet Cat reserves the right
      to remove any of Your Content from this Website at any time without notice.</p>
    <ol start="5">
      <li><strong>No warranties</strong>
      </li>
    </ol>
    <p>This Website is provided “as is,” with all faults, and Wallet Cat express no representations or warranties, of
    ...
    <p>In no event shall Wallet Cat, nor any of its officers, directors and employees, shall be held liable for anything
      arising out of or in any way connected with your use of this
      <a href="https://wallet.pp.ua/" target="_blank">Website</a>    whether such liability is under contract.
      &nbsp;Wallet Cat, including its officers, directors and employees
    ...
    <p>You hereby indemnify to the fullest extent Wallet Cat from and against any and/or all liabilities, costs,
    ...
    <p>Wallet Cat is permitted to revise these Terms at any time as it sees fit, and by using this Website you are
      expected to review these Terms on a regular basis.</p>
    <ol start="10">
      <li><strong>Assignment</strong>
      </li>
    </ol>
    <p>The Wallet Cat is allowed to assign, transfer, and subcontract its rights and/or obligations under these Terms
    ...
    <p>These Terms constitute the entire agreement between Wallet Cat and you in relation to your use of this Website,
      and supersede all prior agreements and understandings.</p>
    <ol start="12">
      <li><strong>Governing Law &amp; Jurisdiction</strong>
      </li>
    </ol>
    <p>These Terms will be governed by and interpreted in accordance with the laws of the State of Ukraine, and you
      submit to the non-exclusive jurisdiction of the state and federal courts located in Ukraine for the resolution
      of any disputes.</p>
  </div>
)
